...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      ...
      <BrowserRouter>
        {/*
         * `fallback={null}` de propósito: nas landings o HTML pré-renderizado
         * já está na tela, e um spinner apagaria o conteúdo para depois
         * repintá-lo. Nulo, a página pré-renderizada permanece visível até o
         * chunk chegar e o React assumir.
         */}
