  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "A resina é aplicada diretamente em consultório, permite ajustes e reparos pontuais e costuma ser mais acessível. A porcelana é confeccionada em laboratório e tem maior resistência a manchas. Na avaliação indicamos qual faz mais sentido para o seu caso.",
      },
      {
